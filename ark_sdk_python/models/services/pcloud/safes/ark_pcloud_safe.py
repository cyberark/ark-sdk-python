...
class ArkPCloudBaseSafe(ArkCamelizedModel):
    safe_name: Optional[str] = Field(description='Name of the safe')
    description: Optional[str] = Field(description='Description about the safe')
    ...
    number_of_versions_retention: Optional[int] = Field(description='Number of retention versions on the safe objects')
    ...
    managing_cpm: Optional[str] = Field(description='Managing CPM of the safe')


class ArkPCloudSafe(ArkPCloudBaseSafe):
    creator: Optional[ArkPCloudSafeCreator] = Field(description='Creator of the safe')
    creation_time: Optional[int] = Field(description='Creation time of the safe')
    last_modification_time: Optional[int] = Field(description='Last time the safe was modified')
    safe_id: str = Field(description='Safe url to access with as an id', alias='safeUrlId')
    safe_number: Optional[int] = Field(description='ID number of the safe')
    is_expired_member: Optional[bool] = Field(description='Whether any member is expired')
