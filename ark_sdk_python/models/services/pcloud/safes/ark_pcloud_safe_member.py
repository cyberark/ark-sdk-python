...
class ArkPCloudSafeMember(ArkCamelizedModel):
    ...
    membership_expiration_date: Optional[int] = Field(default=None, description='Expiration date of the member on the safe')
    is_expired_membership_enable: Optional[bool] = Field(default=None, description='Whether expired membership is enabled or not')
