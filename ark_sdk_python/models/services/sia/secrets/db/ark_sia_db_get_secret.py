...
class ArkSIADBGetSecret(ArkModel):
    secret_id: Optional[str] = Field(default=None, description='ID of the secret to get')
    secret_name: Optional[str] = Field(default=None, description='Name of the secret to get')
