...
class ArkSIADBEnableSecret(ArkModel):
    secret_id: Optional[str] = Field(default=None, description='ID of the secret to enable')
    secret_name: Optional[str] = Field(default=None, description='Name of the secret to enable')
