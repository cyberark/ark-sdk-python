...
class CertificateMetadata(ArkCamelizedModel):
    issuer: Optional[str] = Field(description='Certificate issuer', default=None)
...
class ArkSIACreateCertificateBase(ArkModel):
    cert_type: Optional[CertificateTypes] = Field(default=None, description='Certificate type i.e. PEM, p7b, pfx', min_length=1)
...
class ArkSIACreateCertificateRequest(ArkSIACreateCertificateBase):
    cert_body: str = Field(description='Certificate body content', min_length=1)


class ArkSIACreateCertificate(ArkSIACreateCertificateBase):
    certificate_body: Optional[str] = Field(default=None, description='Certificate body content')
    file: Optional[FilePath] = Field(default=None, description='Path to a file with the certificate body')


class ArkSIACertificate(ArkModel):
    ...
    created_by: Optional[str] = Field(default=None, description='Author of the certificate entry')
    last_updated_by: Optional[str] = Field(default=None, description='Author of last certificate entry update')
...
class ArkSIAShortCertificate(ArkModel):
    certificate_id: str = Field(description='ID of the Certificate', min_length=1)
