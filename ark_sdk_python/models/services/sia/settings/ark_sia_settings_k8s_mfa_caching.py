...
class ArkSIASettingsK8SMfaCaching(ArkCamelizedModel):
    ...
    client_ip_enforced: Optional[bool] = Field(default=None, description="Is client IP enforced for MFA caching")
