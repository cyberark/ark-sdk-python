...
from ark_sdk_python.models.services.sia.sso import ArkSIASSOGetShortLivedPassword
...
SERVICE_CONFIG: Final[ArkServiceConfig] = ArkServiceConfig(
    service_name='sia-db', required_authenticator_names=['isp'], optional_authenticator_names=[]
)
ASSETS_API: Final[str] = 'api/adb/guidance/generate'


class ArkSIADBService(ArkService):
